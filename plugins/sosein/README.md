...
This package connects your agent (Codex or Claude Code) to production Sosein.

```text
https://app.sosein.ai/mcp
```
...
signed-in human user's current Sosein permissions. If access is missing,
...
The bundled `sosein` skill is the operational guide loaded by agents. Keep
