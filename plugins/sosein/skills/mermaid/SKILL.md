---
name: mermaid
description: Use when authoring or editing a Mermaid diagram for a Sosein artifact, including choosing the diagram type, writing syntax that Sosein's strict renderer accepts, and placing the diagram through the Sosein MCP tools.
---
