---
name: sosein
description: Use when the user wants to recall Sosein's production memories or search, read, compare, find in, outline, create, edit, or review Sosein's production artifacts, structured objects, or annotation threads through the Sosein MCP plugin.
---
